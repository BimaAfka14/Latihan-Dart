...
void main(List<String> arguments) {
  ...
  // dataKaryawan.add(Pejabat("A123", "Lars Bark", TipeJabatan.direktur));
  // dataKaryawan.add(Pejabat("B123", "Kasper Lund", TipeJabatan.manajer));
  // dataKaryawan[1].thnMasuk = 2016;
  // dataKaryawan.add(StaffBiasa("C123", "Denis Ritchie", thnMasuk: 2020));
...
List<Karyawan> genData(var lisData) {
  List<Karyawan> data = [];

  for (var dtPegawai in lisData) {
    Karyawan pegawai;
